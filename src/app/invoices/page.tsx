...
export default function InvoicesPage() {
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto">
      ...
      {/* Invoices List Table */}
      <div className="bg-transparent lg:bg-white lg:rounded-2xl lg:border lg:border-slate-100 lg:shadow-sm overflow-hidden no-print">
        {loading ? (
          <div className="py-12">
            <InvoicePreloader text="Loading invoices..." />
          </div>
        ) : invoices.length > 0 ? (
          <>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:hidden">
              {invoices.map((invoice) => (
                <div key={invoice.id} className="bg-white rounded-xl border border-slate-200/60 p-4 shadow-xs space-y-4 hover:bg-slate-50/20 hover:shadow-md transition-all">
