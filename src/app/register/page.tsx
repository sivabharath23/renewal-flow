...
import { KeyRound, Mail, User, ShieldCheck, Briefcase, ChevronDown } from 'lucide-react';
            ...
            <div className="space-y-1">
              ...
              <div className="relative w-full">
                ...
                <select
                  ...
                  required
                  defaultValue=""
                  className="w-full appearance-none pl-10 pr-10 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm text-slate-750 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-600 transition-all font-medium"
                >
